...
public class RatatingTransition implements Transtition{
    private static final RatatingTransition instance = new RatatingTransition();
    private float duration;
    private Interpolation interpolation;
    private float angle;
    private TransitionScaling scaling;

    public static RatatingTransition init(float duration, Interpolation interpolation, float angle, TransitionScaling scaling) {
